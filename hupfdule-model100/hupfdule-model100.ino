 ...
 *                                                                                                      generated by [keymapviz] */
  [DEITY] = KEYMAP_STACKED  // {{{2
  (M(MACRO_TOGGLE_AUTOSHIFT), Key_1,  Key_2,         Key_3,       Key_4,              Key_5,       LSHIFT(RALT(Key_RightControl)),
 ...
 * │      │      │      │      │      │      │      │                           │M(MACR│      │      │  =   │      │  −   │      │
 * ├──────┼──────┼──────┼──────┼──────┼──────┼──────┤                           ├──────┼──────┼──────┼──────┼──────┼──────┼──────┤
 * │      │      │ KP_7 │ KP_8 │ KP_9 │      │      │                           │      │  :   │  7   │  8   │  9   │  +   │  ␣   │
 * ├──────┼──────┼──────┼──────┼──────┼──────┤      │                           │      ├──────┼──────┼──────┼──────┼──────┼──────┤
 * │      │      │ KP_4 │ KP_5 │ KP_6 │ KP_0 ├──────┤                           ├──────┤  .   │  4   │  5   │  6   │  /   │  =   │
 * ├──────┼──────┼──────┼──────┼──────┼──────┤      │                           │      ├──────┼──────┼──────┼──────┼──────┼──────┤
 * │      │      │ KP_1 │ KP_2 │ KP_3 │      │      │                           │      │  ,   │  1   │  2   │  3   │  ×   │  ↵   │
 * └──────┴──────┴──────┴──────┴──────┴──────┴──────┘                           └──────┴──────┴──────┴──────┴──────┴──────┴──────┘
 *
 *                             ┌──────┬──────┐                                         ┌──────┬──────┐
 *                             │      │ NUM  ├──────┐                           ┌──────┤  0   │      │
 ...
 *                                                                                                      generated by [keymapviz] */
  ...
  (___, ___, ___,         ___,         ___,         ___,         ___,
   ...
   ___, ___, Key_Keypad4, Key_Keypad5, Key_Keypad6, Key_Keypad0,
   ___, ___, Key_Keypad1, Key_Keypad2, Key_Keypad3, ___,         ___,
...
/* ┌──────┬──────┬──────┬──────┬──────┬──────┬──────┐                           ┌──────┬──────┬──────┬──────┬──────┬──────┬──────┐
 * │      │  F1  │  F2  │  F3  │  F4  │  F5  │LEDEff│                           │  ⏮   │  F6  │  F7  │  F8  │  F9  │ F10  │ F11  │
 * ├──────┼──────┼──────┼──────┼──────┼──────┼──────┤                           ├──────┼──────┼──────┼──────┼──────┼──────┼──────┤
 * │  ⭾   │  ^W  │←🖰 Scr│↑🖰 Scr│→🖰 Scr│  ⎇F  │      │                           │      │  ⏭   │ RST  │  ⭾   │      │  ⎋   │ F12  │
 * ├──────┼──────┼──────┼──────┼──────┼──────┤  ␣   │                           │  ⏯   ├──────┼──────┼──────┼──────┼──────┼──────┤
 * │  ^R  │  ^S  │ 🖰 R  │↓🖰 Scr│ 🖰 L  │  ⎇B  ├──────┤                           ├──────┤  ⬅   │  ⬇   │  ⬆   │  ➡   │  /   │      │
 * ├──────┼──────┼──────┼──────┼──────┼──────┤      │                           │      ├──────┼──────┼──────┼──────┼──────┼──────┤
 * │      │  ⎙   │  ⎀   │  ⇤   │  ⇥   │  ⌦   │  ↵   │                           │  ☰   │  ⌫   │  🕩   │  🕪   │  🕨   │  \   │      │
...
COLORMAPS(
  ...
  (__B, __B, __B,     __B,     __B,     __B,   __B,
   __B, __B, MAGENTA, MAGENTA, MAGENTA, __B,   __B,
   __B, __B, MAGENTA, MAGENTA, MAGENTA, BROWN,
   __B, __B, MAGENTA, MAGENTA, MAGENTA, __B,   __B,
   __B, __B, __B,     __B,
   __B,
...
//  Qukeys.setMinimumPriorInterval(80);
  ...
  // ---- LongPress config
  LONGPRESS(
    kaleidoscope::plugin::LongPressKey(DEITY, KeyAddr(3, 3),     Key_K),
    kaleidoscope::plugin::LongPressKey(DEITY, KeyAddr(3, 4),     Key_Z),

    /// Left side
    // top row
    kaleidoscope::plugin::LongPressKey(DEITY, Key_1,         Key_0),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_2,         Key_9),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_3,         Key_8),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_4,         Key_7),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_5,         Key_6),
    // upper row                   Mapping
    kaleidoscope::plugin::LongPressKey(DEITY, Key_Q,         Key_W),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_T,         Key_M),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_U,         Key_L),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_A,         Key_H),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_F,         Key_P),
    // home row                    Mapping
    kaleidoscope::plugin::LongPressKey(DEITY, Key_C,         Key_G),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_D,         Key_S),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_E,         Key_R),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_I,         Key_N),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_O,         Key_B),
    // lower row                   Mapping
    kaleidoscope::plugin::LongPressKey(DEITY, Key_X,         Key_Eszett), // position differs
    kaleidoscope::plugin::LongPressKey(DEITY, Key_V,         Key_J), // position differs
    ...
    kaleidoscope::plugin::LongPressKey(DEITY, Key_Minus,     Key_Y),
    /// Right side                 Mapping
    // top row                     Mapping
    kaleidoscope::plugin::LongPressKey(DEITY, Key_6,         Key_5),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_7,         Key_4),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_8,         Key_3),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_9,         Key_2),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_0,         Key_1),
    // upper row                   Mapping
    kaleidoscope::plugin::LongPressKey(DEITY, Key_P,         Key_F),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_H,         Key_A),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_L,         Key_U),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_M,         Key_T),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_W,         Key_Q),
    // home row                    Mapping
    kaleidoscope::plugin::LongPressKey(DEITY, Key_B,         Key_O),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_N,         Key_I),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_R,         Key_E),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_S,         Key_D),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_G,         Key_C),
    // lower row                   Mapping
    kaleidoscope::plugin::LongPressKey(DEITY, Key_Y,         Key_Minus),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_Z,         Key_Period),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_K,         Key_Comma),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_Backslash, Key_V),
    kaleidoscope::plugin::LongPressKey(DEITY, Key_Slash,     Key_X),
  )
} // }}}1
